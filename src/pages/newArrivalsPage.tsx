...
const allProducts = [
  { id: 1,  name: 'Diffuser',              category: 'Home Essentials', subcategory: 'smart-gadgets', price: 15000, badge: 'Best Seller', image: diffuser,          slug: 'diffuser',               addedDate: '2025-01-01' },
  { id: 2,  name: 'Green Stick Mask',      category: 'Skincare',        subcategory: 'face',          price: 5000,  badge: 'Top Rated',   image: mask,              slug: 'green-stick-mask',       addedDate: '2025-01-01' },
  { id: 3,  name: 'Tote Bag',              category: 'Accessories',     subcategory: 'bags',          price: 8500,  badge: 'New',         image: totebag,           slug: 'tote-bag',               addedDate: '2026-03-07' },
  { id: 4,  name: '3D Sand Drop',          category: 'Home Essentials', subcategory: 'smart-gadgets', price: 10000, badge: 'Trending',    image: sanddrop,          slug: '3D-sand-drop',           addedDate: '2025-01-10' },
  { id: 5,  name: 'Bathroom Organizer',    category: 'Home Essentials', subcategory: 'bathroom',      price: 15000, badge: 'Best Seller',  image: bathroomOrganizer, slug: 'bathroom-organizer',     addedDate: '2025-01-05' },
  { id: 6,  name: 'Smart-Watch Set',       category: 'Accessories',     subcategory: 'jewelry',       price: 40000, badge: 'Premium',     image: smartwatch,        slug: 'smart-watch-set',        addedDate: '2025-01-01' },
  { id: 7,  name: 'Matte Stanley Tumbler', category: 'Accessories',     subcategory: 'drinkware',     price: 18000, badge: 'New',         image: tumbler,           slug: 'matte-stanley-tumbler',  addedDate: '2026-03-08' },
  { id: 8,  name: 'Flower Vase',           category: 'Home Essentials', subcategory: 'kitchen',       price: 12000, badge: 'New',         image: flowervase,        slug: 'flower-vase',            addedDate: '2026-03-09' },
  { id: 9,  name: 'Ceramic Cup Set',       category: 'Home Essentials', subcategory: 'kitchen',       price: 22000, badge: 'New',         image: ceramiccupset,     slug: 'ceramic-cup-set',        addedDate: '2026-03-10' },
  { id: 10, name: 'Travel Box',            category: 'Skincare',        subcategory: 'travel-kits',   price: 9500,  badge: 'New',         image: travelbox,         slug: 'travel-box',             addedDate: '2026-03-10' },
  { id: 11, name: 'Star Pimple Patches',   category: 'Skincare',        subcategory: 'face',          price: 1300,  badge: 'Trending',    image: pimplepatches,     slug: 'star-pimple-patches',    addedDate: '2025-01-20' },
  { id: 12, name: 'Laptop Stand',          category: 'Accessories',     subcategory: 'smart-gadgets', price: 8000,  badge: 'Trending',    image: laptopstand,       slug: 'laptop-stand',           addedDate: '2025-01-15' },
  { id: 13, name: 'Travel Kit',            category: 'Skincare',        subcategory: 'travel-kits',   price: 14500, badge: 'Best Seller',  image: travelkit,        slug: 'travel-kit',             addedDate: '2025-01-08' },
  { id: 14, name: 'Stanley Cup Accessories', category: 'Accessories',   subcategory: 'drinkware',     price: 25000, badge: 'Trending',    image: stanleycup,        slug: 'stanley-cup-accessories', addedDate: '2025-01-01' },
  { id: 15, name: 'Storage Basket',        category: 'Home Essentials', subcategory: 'kitchen',       price: 7500,  badge: 'New',         image: storagebasket,     slug: 'storage-basket',         addedDate: '2026-03-12' },
  { id: 16, name: 'Moonlight Lamp',        category: 'Home Essentials', subcategory: 'lighting',      price: 14500, badge: 'New',         image: rotatinglight,     slug: 'moonlight-lamp',         addedDate: '2026-03-12' },
  { id: 17, name: 'Relaxation Chair',      category: 'Home Essentials', subcategory: 'personal-care', price: 85000, badge: 'Premium',     image: relaxationchair,   slug: 'relaxation-chair',       addedDate: '2025-01-01' },
  { id: 18, name: 'Boob Tape',             category: "Women's Essentials", subcategory: 'personal-care', price: 3500, badge: 'Best Seller', image: booptape,       slug: 'boob-tape',              addedDate: '2025-01-20' },
  { id: 19, name: 'Over-The-Toilet Organizer Rack', category: 'Home Essentials', subcategory: 'bathroom', price: 15000, badge: 'New',   image: toiletrack,        slug: 'over-the-toilet-organizer-rack', addedDate: '2026-03-14' },
  { id: 20, name: 'Phone Suction Cup',     category: 'Accessories',     subcategory: 'smart-gadgets', price: 1000,  badge: 'New',         image: phonesuction,      slug: 'phone-suction-cup',      addedDate: '2026-03-14' },
  { id: 21, name: 'RGB Phone LED Light',   category: 'Accessories',     subcategory: 'smart-gadgets', price: 8000,  badge: 'New',         image: rgbled,            slug: 'rgb-phone-led-light',    addedDate: '2026-03-15' },
  { id: 22, name: 'Wireless Fill Light BT Remote Tripod', category: 'Accessories', subcategory: 'smart-gadgets', price: 12000, badge: 'New', image: tripod, slug: 'wireless-fill-light-bt-remote-tripod', addedDate: '2026-03-15' },
  { id: 23, name: 'Crystal Diamond LED Lamp', category: 'Home Essentials', subcategory: 'lighting',  price: 13000, badge: 'New',         image: ledlamp,           slug: 'crystal-diamond-led-lamp', addedDate: '2026-03-16' },
  { id: 24, name: 'Floral & Fruit Fragrance Hand Cream', category: 'Skincare', subcategory: 'body',  price: 700,   badge: 'New',         image: handcream,         slug: 'floral-fruit-fragrance-hand-cream', addedDate: '2026-03-16' },
  { id: 25, name: 'Multifunctional Towel Organizer', category: 'Home Essentials', subcategory: 'bathroom', price: 12000, badge: 'New',   image: towelrack,         slug: 'multifunctional-towel-organizer', addedDate: '2026-03-17' },
  { id: 26, name: '3 Layers Jewelry Box With Key', category: 'Home Essentials', subcategory: 'organizers', price: 32000, badge: 'New',  image: jewelrybox,        slug: '3-layers-jewelry-box-with-key', addedDate: '2026-03-17' },
  { id: 27, name: 'Foldable Swivel Mosquito Bat', category: 'Home Essentials', subcategory: 'smart-gadgets', price: 15000, badge: 'New', image: mosquitobat, slug: 'foldable-swivel-mosquito-bat', addedDate: '2026-03-18' },
  { id: 28, name: 'Underwear Organizer',   category: 'Home Essentials', subcategory: 'organizers',    price: 4000,  badge: 'New',         image: underwear,         slug: 'underwear-organizer',    addedDate: '2026-03-18' },
  { id: 29, name: 'Quick Shoe Wipe',       category: 'Home Essentials', subcategory: 'personal-care', price: 5000,  badge: 'New',         image: shoewipe,          slug: 'quick-shoe-wipe',        addedDate: '2026-03-19' },
  { id: 30, name: 'Happy Supply Chain Water Bottle', category: 'Accessories', subcategory: 'drinkware', price: 7000, badge: 'New',       image: waterbottle,       slug: 'happy-supply-chain-water-bottle', addedDate: '2026-03-19' },
  { id: 31, name: 'Inspirational Wall Stickers', category: 'Home Essentials', subcategory: 'decor',  price: 9000,  badge: 'New',         image: wallstickers,      slug: 'inspirational-wall-stickers', addedDate: '2026-03-20' },
  { id: 32, name: 'Bubble Gun',            category: 'Accessories',     subcategory: 'smart-gadgets', price: 10000, badge: 'New',         image: bubblegun,         slug: 'bubble-gun',             addedDate: '2026-03-20' },
  { id: 33, name: 'USB Cigarette Lighter Mobile Phone Holder', category: 'Accessories', subcategory: 'smart-gadgets', price: 10000, badge: 'New', image: usblighter, slug: 'usb-cigarettes-lighter-mobile-phone-holder', addedDate: '2026-03-21' },
  { id: 34, name: 'Double Sided Nano Tape', category: 'Home Essentials', subcategory: 'organizers',  price: 6000,  badge: 'New',         image: nanotape,          slug: 'double-sided-nano-tape', addedDate: '2026-03-21' },
  { id: 35, name: 'Gold Decor Tape',       category: 'Home Essentials', subcategory: 'decor',        price: 5000,  badge: 'New',         image: goldtape,          slug: 'gold-decor-tape',        addedDate: '2026-03-22' },
  { id: 36, name: 'Vine Leaf Room Decor',  category: 'Home Essentials', subcategory: 'decor',        price: 1800,  badge: 'New',         image: vineleaf,          slug: 'vine-leaf-room-decor',   addedDate: '2026-03-22' },
  { id: 37, name: 'Decorative Wall Hooks', category: 'Home Essentials', subcategory: 'decor',        price: 1500,  badge: 'New',         image: wallhook,          slug: 'decorative-wall-hooks',  addedDate: '2026-03-23' },
  { id: 38, name: 'Fancy Barbie Pen',      category: 'Accessories',     subcategory: 'accessories',  price: 2000,  badge: 'New',         image: barbiepen,         slug: 'fancy-barbie-pen',       addedDate: '2026-03-23' },
  { id: 39, name: 'Multifunctional Wall Mounted Trash Can', category: 'Home Essentials', subcategory: 'kitchen', price: 4500, badge: 'New', image: trashcan, slug: 'multifunctional-wall-mounted-trash-can', addedDate: '2026-03-24' },
  { id: 40, name: 'Transparent Boobs Lifter', category: "Women's Essentials", subcategory: 'personal-care', price: 4500, badge: 'New',  image: booblifter,        slug: 'transparent-boobs-lifter', addedDate: '2026-03-24' },
  { id: 41, name: 'Smart Watch (Series 8)', category: 'Accessories',    subcategory: 'jewelry',      price: 25000, badge: 'New',         image: series8,           slug: 'smart-watch-series-8',   addedDate: '2026-03-24' },
  { id: 42, name: 'Compressed Facial Towel', category: 'Skincare',      subcategory: 'face',         price: 200,   badge: 'New',         image: facetowel,         slug: 'compressed-facial-towel', addedDate: '2026-03-25' },
  { id: 43, name: 'SADOER Ampoules Facial Mask', category: 'Skincare',  subcategory: 'face',         price: 800,   badge: 'New',         image: facemask,          slug: 'sadoer-ampoules-facial-mask', addedDate: '2026-03-25' },
  { id: 44, name: 'Tongue Scrubber',       category: 'Skincare',        subcategory: 'face',         price: 1000,  badge: 'New',         image: tonguescrubber,    slug: 'tongue-scrubber',        addedDate: '2026-03-26' },
  { id: 45, name: 'Stanley Cup',           category: 'Accessories',     subcategory: 'drinkware',    price: 17000, badge: 'Best Seller',  image: stanley,          slug: 'stanley-cup',            addedDate: '2025-01-05' },
  { id: 46, name: 'Self-adhesive Countertop Film', category: 'Home Essentials', subcategory: 'decor', price: 8000, badge: 'Best Seller', image: counterfilm, slug: 'self-adhesive-countertop-film', addedDate: '2025-01-05' },
  { id: 47, name: 'AC Cooling Humidifier Fan', category: 'Home Essentials', subcategory: 'smart-gadgets', price: 25000, badge: 'Best Seller', image: fan, slug: 'ac-cooling-humidifier-fan', addedDate: '2025-01-05' },
  { id: 48, name: 'Cooking Flipper',       category: 'Home Essentials', subcategory: 'kitchen',      price: 5000,  badge: 'Best Seller',  image: flipper,          slug: 'cooking-flipper',        addedDate: '2025-01-06' },
  { id: 49, name: 'E-30 Camera Fill Light', category: 'Home Essentials', subcategory: 'smart-gadgets', price: 32000, badge: 'Best Seller', image: filllight, slug: 'e-30-camera-fill-light', addedDate: '2025-01-06' },
  { id: 50, name: '5 IN 1 Multipurpose Organizer', category: 'Home Essentials', subcategory: 'bathroom', price: 20000, badge: 'Best Seller', image: bathroom, slug: '5in1-multipurpose-organizer', addedDate: '2025-01-06' },
  { id: 51, name: 'Ultra-Portable Multi-Functional Juicer Cup', category: 'Home Essentials', subcategory: 'kitchen', price: 14000, badge: 'Best Seller', image: juicer, slug: 'ultra-portable-multi-functional-juicer-cup', addedDate: '2025-01-06' },
  { id: 52, name: '360 Motion Sensor Light', category: 'Home Essentials', subcategory: 'lighting',   price: 13000, badge: 'Best Seller',  image: sensorlight,      slug: '360-motion-sensor-light', addedDate: '2025-01-06' },
]
